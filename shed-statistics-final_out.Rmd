...
impulse_day1 <- read.delim(file = "C:\\Users\\kmh\\Documents\\GitHub\\shed-tits\\data\\impulse_day0.csv", sep = ",")
...
```{r}
#select columns
impulse_day0 <- impulse_day0 %>% select("id", event_no = event2, "impulse", "duration")
impulse_day1 <- impulse_day1 %>% select("id", event_no = event2, "impulse", "duration")
impulse_dayminus1 <- impulse_dayminus1 %>% select("id", event_no = event2, "impulse", "duration")
