...
# impulse data 
impulse_day0 <- read.delim(file = "C:\\Users\\kmh\\Documents\\GitHub\\shed-tits\\data\\impulse_day0.csv", sep = ",")

impulse_day1 <- read.delim(file = "C:\\Users\\kmh\\Documents\\GitHub\\shed-tits\\data\\impulse_day1.csv", sep = ",")

impulse_dayminus1 <- read.delim(file = "C:\\Users\\kmh\\Documents\\GitHub\\shed-tits\\data\\impulse_dayminus1.csv", sep = ",")
...
#scare response
rlmer_impulse_predict <- predict_response(rlmer3_impulse_group, "scare_outcome", margin = "empirical")
...
impulse_scare_lmer <- plot(lmer_impulse_predict)+ labs(x ="", y = "impulse (mN*s)", title = "") #+
  #theme(
    ...
    #axis.text.x = element_text(size = 18),  # normal vs.escape
...
#group response
## rlmer
rlmer_impulse_group_predict <- predict_response(rlmer3_impulse_group, c("day_since","exp_group"),margin = "empirical")
...
impulse_group <- plot(rlmer_impulse_group_predict) + labs(x = "", y = "impulse (mN*s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7"))+ theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 16),   # y label
    axis.text.x = element_text(size = 16),    # tick marks
...
#scare response
rlmer_duration_predict <- predict_response(rlmer_duration_bluti_group, "scare_outcome", margin = "empirical")
...
#group response
##rlmer
rlmer_duration_group_predict <- predict_response(rlmer_duration_bluti_group, c("day_since","exp_group"),margin = "empirical")
...
#scare response
rlmer_impulse_ratio_predict <- predict_response(rlmer2_impulse_ratio_group, "scare_outcome", margin = "empirical")
...
#group response
##rlmer
rlmer_impulse_ratio_group_predict <- predict_response(rlmer2_impulse_ratio_group, c("day_since","exp_group"),margin = "empirical")
...
impulse_ratio_group_lmer <- plot(lmer_impulse_ratio_group_predict) + labs(x = "", y = "impulse ratio", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) +theme(legend.position = "none") #+
  #theme(
  # axis.title.y = element_text(size = 24),   # y label
  #  axis.text.x = element_text(size = 18),    # tick marks
  #  axis.text.y = element_text(size = 18)   
...
v1_group <- plot(rlmer_v1_group_predict)+ labs(x = "day since experiment", y = "v1 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
...
v1_group_lmer <- plot(lmer_v1_group_predict)+ labs(x = "day since experiment", y = "v1 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
...
v2_group <- plot(rlmer_v2_group_predict)+ labs(x = "day since experiment", y = "v2 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
...
v2_group_lmer <- plot(lmer_v2_group_predict)+ labs(x = "day since experiment", y = "v2 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
...
v3_group <- plot(rlmer_v3_group_predict) + labs(x = "day since experiment", y = "v3 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
...
v3_group_lmer <- plot(lmer_v3_group_predict) + labs(x = "day since experiment", y = "v3 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
...
v4_group <- plot(rlmer_v4_group_predict)+ labs(x = "day since experiment", y = "v4 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
...
v4_group_lmer <- plot(lmer_v4_group_predict)+ labs(x = "day since experiment", y = "v4 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
...
acc1_group <- plot(rlmer_acc1_group_predict)+ labs(x = "", y = "acc1 (m/s^2)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
    axis.text.y = element_text(size = 18)   
...
acc1_group_lmer <- plot(lmer_acc1_group_predict)+ labs(x = "", y = "acc1 (m/s^2)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
    axis.text.y = element_text(size = 18)   
...
acc2_group <- plot(rlmer_acc2_bluti_predict)+ labs(x = "", y = "acc2 (m/s^2)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
    axis.text.y = element_text(size = 18)   
  )
acc2_group_lmer <- plot(lmer_acc2_bluti_predict)+ labs(x = "", y = "acc2 (m/s^2)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
    axis.text.y = element_text(size = 18)   
...
ggarrange(bw_scare, maxF_scare, acc0_scare,
          Fx_scare, Fy_scare, impulse_scare,
          duration_scare, impulse_ratio_scare, acc1_scare,
          acc2_scare, acc3_scare, v1_scare, 
          v2_scare, v3_scare,v4_scare, nrow = 5, ncol = 3)

```
###### impulse
```{r}
# this is rlmer
ggarrange(impulse_scare, duration_scare, impulse_ratio_scare, impulse_group, duration_group, impulse_ratio_group, nrow =2, ncol = 3)
```
...
###### impulse
```{r}
ggarrange(impulse_scare_lmer, duration_scare_lmer, impulse_ratio_scare_lmer, impulse_group_lmer, duration_group_lmer, impulse_ratio_group_lmer, nrow = 2, ncol = 3 )
```
