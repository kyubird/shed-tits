...
# force data - day0
F_control_full <- read.delim(file ="C:\\Users\\jesu4036\\Documents\\Github\\shed-tits\\data\\final\\F_control_full.csv", sep = ",") 

F_treats_full <- read.delim(file ="C:\\Users\\jesu4036\\Documents\\Github\\shed-tits\\data\\final\\F_treats_full.csv", sep = ",") 

#day1
F_day1_full <- read.delim(file =  "C:\\Users\\jesu4036\\Documents\\Github\\shed-tits\\data\\final\\F_day1_full.csv", sep = ",") 

#day-1 - being processed in VS code
F_dayminus1_full <- read.delim(file =  "C:\\Users\\jesu4036\\Documents\\Github\\shed-tits\\data\\final\\F_dayminus1_full.csv", sep = ",") 

# impulse data 
impulse_day0 <- read.delim(file = "C:\\Users\\jesu4036\\Documents\\Github\\shed-tits\\data\\final\\impulse_day0.csv", sep = ",")

impulse_day1 <- read.delim(file = "C:\\Users\\jesu4036\\Documents\\Github\\shed-tits\\data\\final\\impulse_day1.csv", sep = ",")

impulse_dayminus1 <- read.delim(file = "C:\\Users\\jesu4036\\Documents\\Github\\shed-tits\\data\\final\\impulse_dayminus1.csv", sep = ",")

# IR data
control_ir_full <- read.delim(file = "C:\\Users\\jesu4036\\Documents\\Github\\shed-tits\\data\\final\\ir_control_ordered.csv", sep = ",")

treats_ir_full <- read.delim(file = "C:\\Users\\jesu4036\\Documents\\Github\\shed-tits\\data\\final\\ir_treats_ordered.csv", sep = ",") 

day1_ir_full <- read.delim(file = "C:\\Users\\jesu4036\\Documents\\Github\\shed-tits\\data\\final\\day1_ir_full.csv", sep = ",")

dayminus1_ir_full <- read.delim(file = "C:\\Users\\jesu4036\\Documents\\Github\\shed-tits\\data\\final\\day-1_ir_full.csv", sep = ",")

# temperature data 
temp_CP7 <- read.delim(file = "C:\\Users\\jesu4036\\Documents\\Github\\shed-tits\\data\\final\\temp_CP7.csv", sep = ";", header = FALSE) %>%
  select(V2, V4) %>%
  slice(c(61966:73581),) #2024-11-06 00:00 - 2025-03-06 23:45
  

temp_CP28 <- read.delim(file = "C:\\Users\\jesu4036\\Documents\\Github\\shed-tits\\data\\final\\temp_CP28.csv", sep = ";", header = FALSE) %>%
  select(V2, V4) %>%
  slice(c(62246:73861),)
...
cat("F_control_full dim: ",dim(F_control_full)) #2607
cat("control_ir_full dim: ",dim(control_ir_full)) #1693
cat("F_treats_full dim: ",dim(F_treats_full)) #2679
cat("treats_ir_full dim: ",dim(treats_ir_full)) #1728

cat("impulse day 0 dim: ", dim(impulse_day0)) #2968
cat("impulse day 1 dim: ", dim(impulse_day1)) #2968 crazy that it's exactly same no. of rows as day0! 
cat("impulse day -1 dim: ", dim(impulse_dayminus1)) #3068
...
cat("F_pooled_full dim: ",dim(F_pooled_full)) #5286
cat("pooled_ir_full dim: ",dim(pooled_ir_full)) #3421
```
...
### 5. add impulse column to Force
- power reaction time. 
```{r}

cat("F_pooled_full dim: ",dim(F_pooled_full)) #2607
cat("F_day1_full dim: ",dim(F_day1_full)) #1693
cat("F_dayminus1_full dim: ",dim(F_dayminus1_full)) #2679


#select columns
impulse_day0 <- impulse_day0 %>% select("id", event_no = event2, "impulse", "duration", "impulse_ratio")

impulse_day1 <- impulse_day1 %>% select("id", event_no = event2, "impulse", "duration", "impulse_ratio")

impulse_dayminus1 <- impulse_dayminus1 %>% select("id", event_no = event2, "impulse", "duration", "impulse_ratio")


# merging impulse calculation 
F_pooled_full <- merge(F_pooled_full, impulse_day0, by = c("id", "event_no")) %>%
  filter(impulse > 0.003 )

F_day1_full <- merge(F_day1_full, impulse_day1, by = c("id", "event_no")) %>%
  filter(impulse > 0.003 ) #somehow F_day1_full not showing up. 

F_dayminus1_full <- merge(F_dayminus1_full, impulse_dayminus1, by = c("id", "event_no")) %>%
  filter(impulse > 0.003 )

cat("F_pooled_full dim: ",dim(F_pooled_full)) #2807
cat("F_day1_full dim: ",dim(F_day1_full)) #1693
cat("F_dayminus1_full dim: ",dim(F_dayminus1_full)) #2679
...
### 7. int_acc and bodyweight adjustments
```{r}
#int_acc calculation
...
#### f. binding into one dataset with day0 & day1
```{r}
#F
colnames(F_day1_groups_clean)
colnames(F_day0)
#max_Fx, max_Fy -> takeoff_angle
F_day1_final <- F_day1_groups_clean %>%select("id","visit_datetime","event_no","species","sex","age","bw_filled","hr","celsius.now","int_acc","day_since","group", "bodyweight","max_Ftot","Fx_maxFtot","Fy_maxFtot","takeoff_angle","impulse","duration", "impulse_ratio")

F_dayminus1_final <- F_dayminus1_groups_clean %>% select("id","visit_datetime","event_no","species","sex","age","bw_filled","hr","celsius.now","int_acc","day_since","group", "bodyweight","max_Ftot","Fx_maxFtot","Fy_maxFtot","takeoff_angle","impulse","duration", "impulse_ratio")
...
F_day0_final <- F_day0 %>% select("id","visit_datetime","event_no","species","sex","age","bw_filled","hr","celsius.now","scare_outcome","prev_scares","int_acc","day_since","group", "bodyweight","max_Ftot","Fx_maxFtot","Fy_maxFtot","takeoff_angle","impulse","duration", "impulse_ratio") 
...
```{r}
lmer_impulse = lmer(impulse ~ 1 + day_since*group + scare_outcome + prev_scares + flight_no + sex + age + hr + date + celsius.now + (1|id), data = all_days_F)

lmer_duration = lmer(duration ~ 1 + day_since*group + scare_outcome + prev_scares + flight_no + sex + age + hr + date + celsius.now + (1|id), data = all_days_F)

lmer_impulse_ratio = lmer(impulse_ratio ~ 1 + day_since*group + scare_outcome + prev_scares + flight_no + sex + age + hr + date + celsius.now + (1|id), data = all_days_F)
...
test_impulse <- rosnerTest(all_days_F$impulse, k= 1)
test_impulse$all.stats #no outliers

test_duration <- rosnerTest(all_days_F$duration, k = 1)
test_duration$all.stats #no outliers

test_impulse_ratio <- rosnerTest(all_days_F$impulse_ratio, k = 10)
test_impulse_ratio$all.stats
```

```{r}
test_bw <- rosnerTest(all_days_F$bodyweight, k=1) #no outliers
test_bw$all.stats

test_acc0 <- rosnerTest(all_days_F$int_acc, k=7)
test_acc0$all.stats

test_max_Ftot <- rosnerTest(all_days_F$max_Ftot, k=1) #no outliers
test_max_Ftot$all.stats

test_Fx_maxFtot <- rosnerTest(all_days_F$Fx_maxFtot, k=1)
test_Fx_maxFtot$all.stats #no outliers

test_Fy_maxFtot  <- rosnerTest(all_days_F$Fy_maxFtot, k=2)
...
test_acc2<- rosnerTest(all_days_ir$acc2, k = 17)
test_acc2$all.stats 
...
```{r}
test_exits <- rosnerTest(all_days_ir$exit_s, k = 70)
#more
test_exits$all.stats #not using this response variable as its not useful

test_v3 <- rosnerTest(all_days_ir$v3, k = 70)
...
#  filter(Outlier == "TRUE") %>%
#  select(Obs.Num) #not doing outlier more than 70. 
...
outliers_F <-rbind(out_impulse_ratio, out_acc0, out_Fy)

outliers_IR <- rbind(out_v1, out_v2, out_v4, out_acc1, out_acc2, out_acc3) %>%
  distinct
dim(outliers_F) #19 outliers
dim(outliers_IR)
 #83 outliers
...
dim(ir.out) #7645 -> 7756
dim(force.out) #11408 -> 5430
```
...
dim(force.out.bluti) #3890
dim(force.out.bluti_bal) #2109 flights (3890 - 2109)/3890. 46% flights out, 

dim(ir.out.bluti) #5185
dim(ir.out.bluti_bal) #3871 flights (5185 - 3871)/5185. 25% flights out

dim(force.out.greti) #1540
dim(force.out.greti_bal) #1133 flights (1540-1133)/1540 26% flights out

dim(ir.out.greti) #2571
dim(ir.out.greti_bal) # 1654 flights (2571 - 1654)/2571 flights out, 36% flights out
...
indiv_visit_no <- force.out.bluti_bal %>%
  count(date_label, id, day_since, exp_group) %>%
...
dates_visited
```
#### no. of escape flights vs. spontaneous flights
```{r}
force_scare <- force.out.bluti_bal %>%
...
force_unique_ids_scare <- force.out.bluti_bal %>%
  filter(scare_outcome == 1) %>%
  summarise(unique_id_count = n_distinct(id))


ir_scare <- ir.out.bluti_bal %>%
  group_by(scare_outcome) %>%
  summarise(
    count = n()
  )

ir_unique_ids_scare <- force.out.bluti_bal %>%
  filter(scare_outcome == 1) %>%
  summarise(unique_id_count = n_distinct(id))

force_scare
force_unique_ids_scare
ir_scare
ir_unique_ids_scare
...
force.out.bluti_bal_corcheck <- force.out.bluti_bal %>% select( 'day_since','bodyweight','scare_outcome','celsius.now','hr', 'prev_scares', 'flight_no')
cor.chart_bluti_F = chart.Correlation(force.out.bluti_bal_corcheck, histogram=TRUE, pch=19)



ir.out.bluti_bal_corcheck <- ir.out.bluti_bal %>% select( 'day_since','scare_outcome','celsius.now','hr', 'prev_scares','flight_no')
cor.chart_bluti_ir = chart.Correlation(ir.out.bluti_bal_corcheck, histogram=TRUE, pch=19)




force.out.greti_bal_corcheck <- force.out.greti_bal %>% select( 'day_since','bodyweight','scare_outcome','celsius.now','hr', 'prev_scares', 'flight_no' )
cor.chart_greti_F = chart.Correlation(force.out.greti_bal_corcheck, histogram=TRUE, pch=19)


ir.out.greti_bal_corcheck <- ir.out.greti_bal %>% select( 'day_since','scare_outcome','celsius.now','hr', 'prev_scares','flight_no' )
...
#age (to factor)
force.out.bluti_bal$age <- as.factor(force.out.bluti_bal$age)
ir.out.bluti_bal$age <- as.factor(ir.out.bluti_bal$age)

force.out.greti_bal$age <- as.factor(force.out.greti_bal$age)
ir.out.greti_bal$age <- as.factor(ir.out.greti_bal$age)
...
#day_since (to factor)
force.out.bluti_bal$day_since <- as.factor(force.out.bluti_bal$day_since)
ir.out.bluti_bal$day_since <- as.factor(ir.out.bluti_bal$day_since)

force.out.greti_bal$day_since <- as.factor(force.out.greti_bal$day_since)
ir.out.greti_bal$day_since <- as.factor(ir.out.greti_bal$day_since)
...
# changing 'scare_outcome' to factor. maybe should change characters to factors too? 
...
# sex to factor
force.out.bluti_bal$sex <- as.factor(force.out.bluti_bal$sex)

force.out.greti_bal$sex <- as.factor(force.out.greti_bal$sex)

ir.out.bluti_bal$sex <- as.factor(ir.out.bluti_bal$sex)

ir.out.greti_bal$sex <- as.factor(ir.out.greti_bal$sex)

# exp_group to factor
force.out.bluti_bal$exp_group <- as.factor(force.out.bluti_bal$exp_group)

force.out.greti_bal$exp_group <- as.factor(force.out.greti_bal$exp_group)

ir.out.bluti_bal$exp_group <- as.factor(ir.out.bluti_bal$exp_group)

ir.out.greti_bal$exp_group <- as.factor(ir.out.greti_bal$exp_group)

# date_label to factor
force.out.bluti_bal$date_label <- as.factor(force.out.bluti_bal$date_label)

force.out.greti_bal$date_label <- as.factor(force.out.greti_bal$date_label)

ir.out.bluti_bal$date_label <- as.factor(ir.out.bluti_bal$date_label)

ir.out.greti_bal$date_label <- 
  as.factor(ir.out.greti_bal$date_label)

#id to factor
force.out.bluti_bal$id <- as.factor(force.out.bluti_bal$id)

force.out.greti_bal$id <- as.factor(force.out.greti_bal$id)

ir.out.bluti_bal$id <- as.factor(ir.out.bluti_bal$id)

ir.out.greti_bal$id <- 
  as.factor(ir.out.greti_bal$id)
...
# changing N*s to mN*s 
# 1 Newton: accelerating a one-kilogram mass (1000 g) at a rate of 1 m/s^2
# 1 milli Newton: accelerating a 1g mass at a rate of 1 m/s^2

#changing impulse to mN 
force.out.bluti_bal$impulse <- force.out.bluti_bal$impulse*1000

lm_impulse_bluti_group = lm(impulse ~ 1 + day_since*exp_group + scare_outcome + prev_scares + flight_no + sex + age + hr + celsius.now + date_label + id, data = force.out.bluti_bal)

check_collinearity(lm_impulse_bluti_group)

lmer_impulse_bluti_group = lmer(impulse ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = force.out.bluti_bal)

check_collinearity(lmer_impulse_bluti_group)
#celsius.now + celsius.12hr + month

# Computes the default residuals (raw conditional)
raw_cond_impulse <- compute_redres(lmer_impulse_bluti_group)

#linearity - can't test as all the terms are categorical 
hist(raw_cond_impulse) #normality in histogram
plot_redres(lmer_impulse_bluti_group) #heteroskedasticity
plot_resqq(lmer_impulse_bluti_group) #normality of residuals - heavy tailed and bimodal?
plot_ranef(lmer_impulse_bluti_group) #normality of random effects residuals

simulation_output <- simulateResiduals(fittedModel = lmer_impulse_bluti_group, n = 1000)
...
lmer_impulse_bluti_group = lmer(impulse ~ 1 + day_since*exp_group + scare_outcome + prev_scares + flight_no + age + sex + hr+ celsius.now + date_label+(1|id), data = force.out.bluti_bal)

rlmer_impulse_bluti_group = rlmer(impulse ~ 1 + day_since*exp_group + scare_outcome + prev_scares + flight_no + age + sex + hr+ celsius.now + date_label+(1|id), data = force.out.bluti_bal)

summary(rlmer_impulse_bluti_group)
#plot(rlmer_impulse_bluti_group)
```

```{r}
rlmer2_impulse_group <- update(rlmer_impulse_bluti_group, rho.sigma.e = psi2propII(smoothPsi, k = 1.66), 
                 rho.sigma.b = psi2propII(smoothPsi, k = 1.66)) #both fixed and random effects -> k = 1.66 
```

```{r}
rlmer3_impulse_group <- update(rlmer2_impulse_group,  rho.sigma.e = psi2propII(smoothPsi, k = 2.28), 
                 rho.sigma.b = psi2propII(smoothPsi, k = 2.28))
```

```{r}

AICc(lm_impulse_bluti_group, lmer_impulse_bluti_group)
#lm model a better fit but individual variability critical for the research question & also high collinearity among variables to the id. 
```
```{r}
compare(lmer_impulse_bluti_group, rlmer_impulse_bluti_group, rlmer2_impulse_group, rlmer3_impulse_group, show.rho.functions = FALSE)
#3.26 , 3.52, 3.38, 3.32
```

###### tab_model
```{r}
tab_model(lmer_impulse_bluti_group)
#more previous scare, more frontloading at take-off. 
tab_model(rlmer3_impulse_group)
#impulse increase on the day within treatment group
# but more scare -> lower impulse
```

```{r}
#same conclusion as maxFtot. impulse lower during escape but higher overall for treatment group on the experimental day. 

#scare response
rlmer_impulse_predict <- predict_response(rlmer3_impulse_group, "scare_outcome", margin = "mean_reference")

lmer_impulse_predict <- predict_response(lmer_impulse_bluti_group, "scare_outcome", margin = "mean_reference")

#group response
## rlmer
rlmer_impulse_group_predict <- predict_response(rlmer3_impulse_group, c("day_since","exp_group"),margin = "mean_reference")
##lmer
lmer_impulse_group_predict <- predict_response(lmer_impulse_bluti_group, c("day_since","exp_group"),margin = "mean_reference")


## interaction effect 
rlmer_impulse_bluti_interact <- predict_response(rlmer3_impulse_group, c("day_since","exp_group"),margin = "marginalmeans")

lmer_impulse_bluti_interact <- predict_response(lmer_impulse_bluti_group, c("day_since","exp_group"),margin = "marginalmeans")
...
```{r}
##rlmer -plot
impulse_scare <- plot(rlmer_impulse_predict)+ labs(x ="", y = "impulse (mN*s)", title = "") +
  theme(
    
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 20),    # tick marks
    axis.text.y = element_text(size = 18),
    
    plot.margin = unit(c(5.5, 13, 5.5, 5.5), "pt")
  )
    #axis.title.y = element_text(size = 16),
    #axis.text.x = element_text(size = 16),  # normal vs.escape
    #axis.text.y = element_text(size = 12)   # tick marks 
#  )

##lmer -plot
impulse_scare_lmer <- plot(lmer_impulse_predict)+ labs(x ="", y = "impulse (mN*s)", title = "") +
  theme(
    axis.title.y = element_text(size = 24),
    axis.text.x = element_text(size = 20),  # normal vs.escape
    axis.text.y = element_text(size = 18),   # tick marks 
    plot.margin = unit(c(5.5, 13, 5.5, 5.5), "pt")
  ) 
...
## rlmer - plot
impulse_group <- plot(rlmer_impulse_group_predict) + labs(x = "", y = "impulse (mN*s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7"))+ theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),
    axis.text.x = element_text(size = 22),  # normal vs.escape
    axis.text.y = element_text(size = 18),
    
    plot.margin = unit(c(5.5, 13, 5.5, 5.5), "pt")   # tick marks   
  )

impulse_group_lmer <- plot(lmer_impulse_group_predict) + labs(x = "", y = "impulse (mN*s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) +theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
    axis.text.y = element_text(size = 18),
...
###### test
```{r}
#similar to maxFtot. larger difference btw control and treatment on the experimental day & impulse at escape lower than normal. 
emm_options(rg.limit = 40000, pbkrtest.limit = 6000, lmerTest.limit = 6000)
set.seed(1603)

test_predictions(rlmer_impulse_predict)
test_predictions(lmer_impulse_predict)

test_predictions(rlmer_impulse_group_predict, collapse_levels = TRUE, p_adjust = "sidak")
test_predictions(lmer_impulse_group_predict, collapse_levels = TRUE, p_adjust = "sidak")


test_predictions(rlmer_impulse_bluti_interact, test = "interaction", p_adjust = "sidak")
test_predictions(lmer_impulse_bluti_interact, test = "interaction", p_adjust = "sidak")
...
#pretty good
#changing s -> ms 
force.out.bluti_bal$duration <- force.out.bluti_bal$duration*1000

lmer_duration_bluti_group = lmer(duration ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = force.out.bluti_bal)

check_collinearity(lmer_duration_bluti_group)
#celsius.now + celsius.12hr + month

# Computes the default residuals (raw conditional)
raw_cond_duration <- compute_redres(lmer_duration_bluti_group)

#linearity - can't test as all the terms are categorical 
hist(raw_cond_duration) #normality in histogram
plot_redres(lmer_duration_bluti_group) #heteroskedasticity
plot_resqq(lmer_duration_bluti_group) #normality of residuals - heavy tailed and bimodal?
plot_ranef(lmer_duration_bluti_group) #normality of random effects residuals

# R sessio aborts when running the codes below. 
#simulation_output <- simulateResiduals(fittedModel = lmer_duration_bluti_group, n = 1000)
#plot(simulation_output)
...
##### robustlmm {.tab}
```{r}
# in case passing the assumptions
force.out.bluti_bal$duration <- force.out.bluti_bal$duration*1000

lmer_duration_bluti_group = lmer(duration ~ 1 + day_since*exp_group + scare_outcome + prev_scares + flight_no + age + sex + hr+ celsius.now + date_label+(1|id), data = force.out.bluti_bal)

rlmer_duration_bluti_group = rlmer(duration ~ 1 + day_since*exp_group + scare_outcome + prev_scares + flight_no + age + sex + hr+ celsius.now + date_label+(1|id), data = force.out.bluti_bal)

#summary(rlmer_duration_bluti_group)#
#plot(rlmer_duration_bluti_group)#
```

```{r}
rlmer2_duration_group <- update(rlmer_duration_bluti_group, rho.sigma.e = psi2propII(smoothPsi, k = 1.66), 
                 rho.sigma.b = psi2propII(smoothPsi, k = 1.66)) #both fixed and random effects -> k = 1.66 
```

```{r}
rlmer3_duration_group <- update(rlmer2_duration_group,  rho.sigma.e = psi2propII(smoothPsi, k = 2.28), 
                 rho.sigma.b = psi2propII(smoothPsi, k = 2.28))
```

```{r}
compare(lmer_duration_bluti_group, rlmer_duration_bluti_group, rlmer2_duration_group, rlmer3_duration_group, show.rho.functions = FALSE)
#13 , 12.5, 12.5, 12.8
```

###### tab_model
```{r}
tab_model(lmer_duration_bluti_group)
#more previous scare, less time on the feeder
```

```{r}
tab_model(rlmer_duration_bluti_group)
#more previous scare, jumps off more quickly
#longer take-off with more number of flights
#later the day longer the take-off
```

```{r}
#scare response
rlmer_duration_predict <- predict_response(rlmer_duration_bluti_group, "scare_outcome", margin = "mean_reference")

lmer_duration_predict <- predict_response(lmer_duration_bluti_group, "scare_outcome", margin = "mean_reference")

#group response
##rlmer
rlmer_duration_group_predict <- predict_response(rlmer_duration_bluti_group, c("day_since","exp_group"),margin = "mean_reference")

##lmer
lmer_duration_group_predict <- predict_response(lmer_duration_bluti_group, c("day_since","exp_group"),margin = "mean_reference")

## interaction effect 
rlmer_duration_bluti_interact <- predict_response(rlmer_duration_bluti_group, c("day_since","exp_group"),margin = "marginalmeans")


lmer_duration_bluti_interact <- predict_response(lmer_duration_bluti_group, c("day_since","exp_group"),margin = "marginalmeans")
```
...
##rlmer -plot
duration_scare <- plot(rlmer_duration_predict)+ labs(x ="", y = "duration (ms)", title = "") +
  theme( 
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 20),    # tick marks
    axis.text.y = element_text(size = 18),
...
##lmer -plot
duration_scare_lmer <- plot(lmer_duration_predict)+ labs(x ="", y = "duration (ms)", title = "") +
  theme(
    axis.title.y = element_text(size = 24),
    axis.text.x = element_text(size = 20),  # normal vs.escape
    axis.text.y = element_text(size = 18),
...
duration_group <- plot(rlmer_duration_group_predict) + labs(x = "", y = "duration (ms)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7"))+ theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),
    axis.text.x = element_text(size = 22),  # normal vs.escape
    axis.text.y = element_text(size = 18),
...
duration_group_lmer <- plot(lmer_duration_group_predict) + labs(x = "", y = "duration (ms)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) +theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
    axis.text.y = element_text(size = 18),
...
###### test
```{r}
#duration no difference for scare or group. 

#impulse result similar to maxFtot. larger difference btw control and treatment on the experimental day & impulse at escape lower than normal. 
emm_options(rg.limit = 40000, pbkrtest.limit = 6000, lmerTest.limit = 6000)
set.seed(1603)

test_predictions(rlmer_duration_predict)
test_predictions(lmer_duration_predict)

test_predictions(rlmer_duration_group_predict, collapse_levels = TRUE, p_adjust = "sidak")
test_predictions(lmer_duration_group_predict, collapse_levels = TRUE, p_adjust = "sidak")


test_predictions(rlmer_duration_bluti_interact, test = "interaction", p_adjust = "sidak")
test_predictions(lmer_duration_bluti_interact, test = "interaction", p_adjust = "sidak")
...
##### model assumption
```{r}
# (test) logging impulse_ratio
force.out.bluti_bal$impulse_ratio <- log(force.out.bluti_bal$impulse_ratio)

#conditional tail rising upward -> way better after logging
lmer_impulse_ratio_bluti_group = lmer(impulse_ratio ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = force.out.bluti_bal)

check_collinearity(lmer_impulse_ratio_bluti_group)
#celsius.now + celsius.12hr + month

# Computes the default residuals (raw conditional)
raw_cond_impulse_ratio <- compute_redres(lmer_impulse_ratio_bluti_group)

#linearity - can't test as all the terms are categorical 
hist(raw_cond_impulse_ratio) #normality in histogram
plot_redres(lmer_impulse_ratio_bluti_group) #heteroskedasticity
plot_resqq(lmer_impulse_ratio_bluti_group) #normality of residuals - heavy tailed and bimodal?
plot_ranef(lmer_impulse_ratio_bluti_group) #normality of random effects residuals

simulation_output <- simulateResiduals(fittedModel = lmer_impulse_ratio_bluti_group, n = 1000)
plot(simulation_output)
...
lmer_impulse_ratio_bluti_group = lmer(impulse_ratio ~ 1 + day_since*exp_group + scare_outcome + prev_scares + flight_no + age + sex + hr+ celsius.now + date_label+(1|id), data = force.out.bluti_bal)

rlmer_impulse_ratio_bluti_group = rlmer(impulse_ratio ~ 1 + day_since*exp_group + scare_outcome + prev_scares + flight_no + age + sex + hr+ celsius.now + date_label+(1|id), data = force.out.bluti_bal)

summary(rlmer_impulse_ratio_bluti_group)
#plot(rlmer_impulse_ratio_bluti_group)
```

```{r}
rlmer2_impulse_ratio_group <- update(rlmer_impulse_ratio_bluti_group, rho.sigma.e = psi2propII(smoothPsi, k = 1.66), 
                 rho.sigma.b = psi2propII(smoothPsi, k = 1.66)) #both fixed and random effects -> k = 1.66 
```

```{r}
rlmer3_impulse_ratio_group <- update(rlmer2_impulse_ratio_group,  rho.sigma.e = psi2propII(smoothPsi, k = 2.28), 
                 rho.sigma.b = psi2propII(smoothPsi, k = 2.28))
```

```{r}
compare(lmer_impulse_ratio_bluti_group, rlmer_impulse_ratio_bluti_group, rlmer2_impulse_ratio_group, rlmer3_impulse_ratio_group, show.rho.functions = FALSE)
#0.449, 0.403, 0.4, 0.415. rlmer2
#after logging: 0.341 ,0.328 ,0.326 ,0.335
```

###### tab_model
```{r}
tab_model(lmer_impulse_ratio_bluti_group)
#more previous scare, more frontloading at take-off. later flight order, less frontloading at take-off 

#later in the day, more frontloading
#hotter, less frontloading
```

```{r}
tab_model(rlmer2_impulse_ratio_group)
```

```{r}

#scare response
rlmer_impulse_ratio_predict <- predict_response(rlmer2_impulse_ratio_group, "scare_outcome", margin = "mean_reference")

lmer_impulse_ratio_predict <- predict_response(lmer_impulse_ratio_bluti_group, "scare_outcome", margin = "mean_reference")

#group response
##rlmer
rlmer_impulse_ratio_group_predict <- predict_response(rlmer2_impulse_ratio_group, c("day_since","exp_group"),margin = "mean_reference")

##lmer
lmer_impulse_ratio_group_predict <- predict_response(lmer_impulse_ratio_bluti_group, c("day_since","exp_group"),margin = "mean_reference")

## interaction effect 
rlmer_impulse_ratio_bluti_interact <- predict_response(rlmer2_impulse_ratio_group, c("day_since","exp_group"),margin = "marginalmeans")

lmer_impulse_ratio_bluti_interact <- predict_response(lmer_impulse_ratio_bluti_group, c("day_since","exp_group"),margin = "marginalmeans")
```
...
##rlmer -plot
impulse_ratio_scare <- plot(rlmer_impulse_ratio_predict)+ labs(x ="", y = "log(impulse ratio)", title = "") +
  theme(
    axis.title.y = element_text(size = 24),
    axis.text.x = element_text(size = 20),  # normal vs.escape
    axis.text.y = element_text(size = 18),
...
##lmer -plot
impulse_ratio_scare_lmer <- plot(lmer_impulse_ratio_predict)+ labs(x ="", y = "log(impulse ratio)", title = "") +
  theme(
    axis.title.y = element_text(size = 24),
    axis.text.x = element_text(size = 20),  # normal vs.escape
    axis.text.y = element_text(size = 18),
...
impulse_ratio_scare
impulse_ratio_scare_lmer


impulse_ratio_group <- plot(rlmer_impulse_ratio_group_predict) + labs(x = "", y = "log(impulse ratio)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7"))+ theme(legend.position = "none") +
  theme(
   axis.title.y = element_text(size = 24),   # y label
   axis.text.x = element_text(size = 22),    # tick marks
   axis.text.y = element_text(size = 18),
...
impulse_ratio_group_lmer <- plot(lmer_impulse_ratio_group_predict) + labs(x = "", y = "log(impulse ratio)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) +theme(legend.position = "none") +
  theme(
   axis.title.y = element_text(size = 24),   # y label
   axis.text.x = element_text(size = 22),    # tick marks
   axis.text.y = element_text(size = 18),
...
test_predictions(rlmer_impulse_ratio_predict)
test_predictions(lmer_impulse_ratio_predict)

test_predictions(rlmer_impulse_ratio_group_predict, collapse_levels = TRUE, p_adjust = "sidak")
test_predictions(lmer_impulse_ratio_group_predict, collapse_levels = TRUE, p_adjust = "sidak")


test_predictions(rlmer_impulse_ratio_bluti_interact, test = "interaction", p_adjust = "sidak")
test_predictions(lmer_impulse_ratio_bluti_interact, test = "interaction", p_adjust = "sidak")
...
#0.446, 0.331, 0.346, 0.364. just rlmer
```
###### tab_model
```{r}
...
```{r}
#scare response
rlmer_bw_scare_predict <- predict_response(rlmer_bw_bluti_group, "scare_outcome", margin = "mean_reference")
lmer_bw_scare_predict <- predict_response(lmer_bw_bluti_group, "scare_outcome", margin = "mean_reference")

#group response
##rlmer
rlmer_bw_bluti_predict <- predict_response(rlmer_bw_bluti_group, c("day_since","exp_group"),margin = "mean_reference")
...
##lmer
bw_scare_lmer <- plot(lmer_bw_scare_predict)+ labs(x ="", y = "bodyweight (g)", title = "") +
  theme(
    axis.title.y = element_text(size = 24),
    axis.text.x = element_text(size = 20),  # normal vs.escape
    axis.text.y = element_text(size = 18),
...
bw_group <- plot(rlmer_bw_bluti_predict) + labs(x = "", y = "bodyweight (g)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7"))+ theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
    axis.text.y = element_text(size = 18),
...
#lmer
bw_group_lmer <- plot(lmer_bw_bluti_predict) + labs(x = "", y = "bodyweight (g)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) +theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
    axis.text.y = element_text(size = 18),
...
```{r}
#scare_outcome
rlmer_maxF_scare_predict <- predict_response(rlmer3_maxF_group, "scare_outcome", margin = "mean_reference")
...
rlmer_maxF_group_predict <- predict_response(rlmer3_maxF_group, c("day_since","exp_group"),margin = "mean_reference")
...
maxF_scare_lmer <- plot(lmer_maxF_scare_predict) + labs(x ="", y = "max F (N)", title = "") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 20),    # tick marks
    axis.text.y = element_text(size = 18),
...
maxF_group <- plot(rlmer_maxF_group_predict) + labs(x = "", y = "max F (N)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
    axis.text.y = element_text(size = 18),
...
maxF_group_lmer <- plot(lmer_maxF_group_predict) + labs(x = "", y = "max F (N)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
    axis.text.y = element_text(size = 18),
...
```{r}
# scare comparison 
rlmer_Fx_scare_predict <- predict_response(rlmer_Fx_bluti_group, "scare_outcome",margin = "mean_reference")

lmer_Fx_scare_predict <- predict_response(lmer_Fx_bluti_group, "scare_outcome",margin = "mean_reference")

# group comparison
rlmer_Fx_group_predict <- predict_response(rlmer_Fx_bluti_group, c("day_since","exp_group"),margin = "mean_reference")
...
Fx_scare_lmer <- plot(lmer_Fx_scare_predict) + labs(x= "", y = "Fx (N)", title = "") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 20),    # tick marks
    axis.text.y = element_text(size = 18),
...
Fx_group <- plot(rlmer_Fx_group_predict)+ labs(x = "", y = "Fx (N)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
    axis.text.y = element_text(size = 18),
...
Fx_group_lmer <- plot(lmer_Fx_group_predict)+ labs(x = "", y = "Fx (N)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
    axis.text.y = element_text(size = 18),
...
#0.121, 0.123, 0.121, 0.122 rlmer2
```
###### tab_model
```{r}
...
```{r}
#scare_outcome
rlmer_Fy_scare_predict <- predict_response(rlmer2_Fy_group, "scare_outcome",margin = "mean_reference")

lmer_Fy_scare_predict <- predict_response(lmer_Fy_bluti_group, "scare_outcome",margin = "mean_reference")

#group
rlmer_Fy_group_predict <- predict_response(rlmer2_Fy_group, c("day_since","exp_group"),margin = "mean_reference")
...
Fy_scare_lmer <- plot(lmer_Fy_scare_predict) + labs(x ="", y = "Fy (N)", title = "") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 20),    # tick marks
    axis.text.y = element_text(size = 18),
...
Fy_group <- plot(rlmer_Fy_group_predict) + labs(x = "", y = "Fy (N)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
    axis.text.y = element_text(size = 18),
...
Fy_group_lmer <- plot(lmer_Fy_group_predict) + labs(x = "", y = "Fy (N)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
    axis.text.y = element_text(size = 18),
...
```{r}
#within-individual scare response
rlmer_acc0_scare_predict <- predict_response(rlmer3_acc0_group, "scare_outcome", margin = "mean_reference")

lmer_acc0_scare_predict <- predict_response(lmer_acc0_bluti_group, "scare_outcome", margin = "mean_reference")

#group-level
rlmer_acc0_group_predict <- predict_response(rlmer3_acc0_group, c("day_since","exp_group"), margin = "mean_reference")
...
acc0_scare_lmer <- plot(lmer_acc0_scare_predict) + labs(x ="", y = "acc0 (m/s^2)", title = "") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 20),    # tick marks
    axis.text.y = element_text(size = 18),
...
acc0_group <- plot(rlmer_acc0_group_predict)+ labs(x = "", y = "acc0 (m/s^2)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
    axis.text.y = element_text(size = 18),
...
acc0_group_lmer <- plot(lmer_acc0_group_predict)+ labs(x = "", y = "acc0 (m/s^2)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
    axis.text.y = element_text(size = 18),
...
```{r}
#scare
rlmer_v1_scare_predict <- predict_response(rlmer_v1_bluti_group, "scare_outcome", margin = "mean_reference")

lmer_v1_scare_predict <- predict_response(lmer_v1_bluti_group, "scare_outcome", margin = "mean_reference")

#group
rlmer_v1_group_predict <- predict_response(rlmer_v1_bluti_group, c("day_since","exp_group"),margin = "mean_reference")

lmer_v1_group_predict <- predict_response(lmer_v1_bluti_group, c("day_since","exp_group"),margin = "mean_reference")

#interaction effect
rlmer_v1_group_interact <- predict_response(rlmer_v1_bluti_group, c("day_since","exp_group"),margin = "marginalmeans")
...
v1_scare_lmer <- plot(lmer_v1_scare_predict) + labs(title = "", x = "", y = "v1 (m/s)") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 20),    # tick marks
    axis.text.y = element_text(size = 18),
...
v1_group <- plot(rlmer_v1_group_predict)+ labs(x = "day since scares ", y = "v1 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),
    
  # x tick marks: day since scares  
    axis.text.x = element_text(size = 22),    # y tick marks
    axis.text.y = element_text(size = 18),
    
    plot.margin = unit(c(5.5, 13, 5.5, 5.5), "pt")   
  )

v1_group_lmer <- plot(lmer_v1_group_predict)+ labs(x = "day since scares ", y = "v1 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
...
```{r}
#scare outcome
rlmer_v2_scare_predict <- predict_response(rlmer_v2_bluti_group, "scare_outcome", margin = "mean_reference")

lmer_v2_scare_predict <- predict_response(lmer_v2_bluti_group, "scare_outcome", margin = "mean_reference")

#group-level
rlmer_v2_group_predict <- predict_response(rlmer_v2_bluti_group, c("day_since","exp_group"),margin = "mean_reference")
...
v2_scare_lmer <- plot(lmer_v2_scare_predict) + labs(title = "", x = "", y = "v2 (m/s)") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 20),    # tick marks
    axis.text.y = element_text(size = 18),
...
v2_group <- plot(rlmer_v2_group_predict)+ labs(x = "day since scares ", y = "v2 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
...
v2_group_lmer <- plot(lmer_v2_group_predict)+ labs(x = "day since scares ", y = "v2 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 22),    # tick marks
...
#scare_outcome
rlmer_v3_scare_predict <- predict_response(rlmer_v3_bluti_group, "scare_outcome", margin = "mean_reference")

lmer_v3_scare_predict <- predict_response(lmer_v3_bluti_group, "scare_outcome", margin = "mean_reference")

#group
rlmer_v3_group_predict <- predict_response(rlmer_v3_bluti_group, c("day_since","exp_group"),margin = "mean_reference")
...
v3_scare <- plot(rlmer_v3_scare_predict) + labs(title = "", x ="", y = "v3 (m/s)") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
    axis.text.y = element_text(size = 18)   
  )
v3_scare_lmer <- plot(lmer_v3_scare_predict) + labs(title = "", x ="", y = "v3 (m/s)") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
    axis.text.y = element_text(size = 18)   
...
v3_group <- plot(rlmer_v3_group_predict) + labs(x = "day since scares  ", y = "v3 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
...
v3_group_lmer <- plot(lmer_v3_group_predict) + labs(x = "day since scares  ", y = "v3 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
...
###### test
```{r}
emm_options(rg.limit = 4000, pbkrtest.limit = 4000)
...
#scare
rlmer_v4_scare_predict <- predict_response(rlmer_v4_bluti_group, "scare_outcome", margin = "mean_reference")

lmer_v4_scare_predict <- predict_response(lmer_v4_bluti_group, "scare_outcome", margin = "mean_reference")

#group
rlmer_v4_group_predict <- predict_response(rlmer_v4_bluti_group, c("day_since","exp_group"),margin = "mean_reference")
...
v4_scare_lmer <- plot(lmer_v4_scare_predict) + labs(title = "", x ="", y="v4 (m/s)") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
    axis.text.y = element_text(size = 18)   
...
v4_group <- plot(rlmer_v4_group_predict)+ labs(x = "day since scares  ", y = "v4 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
...
v4_group_lmer <- plot(lmer_v4_group_predict)+ labs(x = "day since scares ", y = "v4 (m/s)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
...
```{r}
#scare
rlmer_acc1_scare_predict <- predict_response(rlmer2_acc1_group, "scare_outcome", margin = "mean_reference")

lmer_acc1_scare_predict <- predict_response(lmer_acc1_bluti_group, "scare_outcome", margin = "mean_reference")

#group

rlmer_acc1_group_predict <- predict_response(rlmer2_acc1_group, c("day_since","exp_group"),margin = "mean_reference")
...
acc1_scare_lmer <- plot(lmer_acc1_scare_predict) + labs(title = "", x = "", y = "acc1 (m/s^2)") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 20),    # tick marks
    axis.text.y = element_text(size = 18),
...
acc1_group <- plot(rlmer_acc1_group_predict)+ labs(x = "day since scares ", y = "acc1 (m/s^2)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 20),    # tick marks
...
acc1_group_lmer <- plot(lmer_acc1_group_predict)+ labs(x = "day since scares ", y = "acc1 (m/s^2)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 20),    # tick marks
...
rlmer_acc2_scare_predict <- predict_response(rlmer_acc2_bluti_group, "scare_outcome", margin = "mean_reference")

lmer_acc2_scare_predict <- predict_response(lmer_acc2_bluti_group, "scare_outcome", margin = "mean_reference")

# group-level
rlmer_acc2_bluti_predict <- predict_response(rlmer_acc2_bluti_group, c("day_since","exp_group"),margin = "mean_reference")
...
acc2_scare_lmer <- plot(lmer_acc2_scare_predict) + labs(title = "", x = "", y = "acc2 (m/s^2)") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 20),    # tick marks
    axis.text.y = element_text(size = 18),
...
acc2_group <- plot(rlmer_acc2_bluti_predict)+ labs(x = "day since scares ", y = "acc2 (m/s^2)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 20),    # tick marks
...
acc2_group_lmer <- plot(lmer_acc2_bluti_predict)+ labs(x = "day since scares ", y = "acc2 (m/s^2)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.x = element_text(size = 24),
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 20),    # tick marks
...
#add the model not controlling for id
#compare with 
...
```{r}
# scare
rlmer_acc3_scare_predict <- predict_response(rlmer_acc3_bluti_group, "scare_outcome", margin = "mean_reference")
lmer_acc3_scare_predict <- predict_response(lmer_acc3_bluti_group, "scare_outcome", margin = "mean_reference")

#group
rlmer_acc3_group_predict <- predict_response(rlmer_acc3_bluti_group, c("day_since","exp_group"),margin = "mean_reference")
...
acc3_scare_lmer <- plot(lmer_acc3_scare_predict) + labs(title = "", x = "", y = "acc3 (m/s^2)") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
    axis.text.y = element_text(size = 18)   
...
acc3_group <- plot(rlmer_acc3_group_predict)+ labs(x = "", y = "acc3 (m/s^2)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
    axis.text.y = element_text(size = 18)   
...
acc3_group_lmer <- plot(lmer_acc3_group_predict)+ labs(x = "", y = "acc3 (m/s^2)", title = "", colour = "group") +scale_color_manual(values = c("#0072B2", "#CC79A7")) + theme(legend.position = "none") +
  theme(
    axis.title.y = element_text(size = 24),   # y label
    axis.text.x = element_text(size = 18),    # tick marks
    axis.text.y = element_text(size = 18)   
...
###### bw - acc3
```{r}
#wider - 3 rows x 4 columns 
ggarrange(bw_scare, maxF_scare, acc0_scare, duration_scare,impulse_scare, impulse_ratio_scare, Fx_scare, Fy_scare,  v1_scare, acc1_scare, v2_scare, acc2_scare, nrow = 3, ncol = 4)
```

##### lmer
###### bw-v1-acc3
```{r}
ggarrange(bw_scare_lmer, maxF_scare_lmer, acc0_scare_lmer, duration_scare_lmer,impulse_scare_lmer, impulse_ratio_scare_lmer, Fx_scare_lmer, Fy_scare_lmer,  v1_scare_lmer, acc1_scare_lmer, v2_scare_lmer, acc2_scare_lmer, nrow = 3, ncol = 4)
...
```{r}
#3 rows x 4 columns 
ggarrange(bw_group, maxF_group, acc0_group, duration_group,impulse_group, impulse_ratio_group, Fx_group, Fy_group,  v1_group, acc1_group, v2_group, acc2_group, nrow = 3, ncol = 4)
...
###### bw-v1-acc3
```{r}
ggarrange(bw_group_lmer, maxF_group_lmer, Fx_group_lmer, Fy_group_lmer,
          acc0_group_lmer, acc1_group_lmer, acc2_group_lmer, acc3_group_lmer,
          v1_group_lmer, v2_group_lmer, v3_group_lmer, v4_group_lmer, nrow = 3, ncol = 4)
...
#### bw
```{r}
bw.rpt <- rpt(bodyweight ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = force.out.bluti_bal, grname = "id", datatype = "Gaussian", nboot = 1000, npermut = 100)

bw.rpt


plot.bw.rpt <- plot(bw.rpt)

plot.bw.rpt
```
#### maxF
```{r}
maxF.rpt <- rpt(max_Ftot ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = force.out.bluti_bal, grname = "id", datatype = "Gaussian", nboot = 1000, npermut = 100)

maxF.rpt

plot.maxF.rpt <- plot(maxF.rpt, main = "individual repeatability for maxF")
...
#### Fx
```{r}
Fx.rpt <- rpt(Fx ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = force.out.bluti_bal, grname = "id", datatype = "Gaussian", nboot = 1000, npermut = 100)

Fx.rpt
plot.Fx.rpt <- plot(Fx.rpt, main = "individual repeatability for Fx")
plot.Fx.rpt
```
#### Fy
```{r}
Fy.rpt <- rpt(Fy ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = force.out.bluti_bal, grname = "id", datatype = "Gaussian", nboot = 1000, npermut = 100)

Fy.rpt
```
#### acc0
```{r}
acc0.rpt <- rpt(int_acc ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = force.out.bluti_bal, grname = "id", datatype = "Gaussian", nboot = 1000, npermut = 100)
...
#### acc1
```{r}
acc1.rpt <- rpt(acc1 ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = ir.out.bluti_bal, datatype = "Gaussian", grname = "id", nboot = 1000, npermut = 100)

acc1.rpt
```
#### acc2
```{r}
acc2.rpt <- rpt(acc2 ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = ir.out.bluti_bal, datatype = "Gaussian", grname = "id", nboot = 1000, npermut = 100)

acc2.rpt
```
#### acc3
```{r}
acc3.rpt <- rpt(acc3 ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = ir.out.bluti_bal, datatype = "Gaussian", grname = "id", nboot = 1000, npermut = 100)

acc3.rpt
```
#### v1
```{r}
v1.rpt <- rpt(v1 ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = ir.out.bluti_bal, datatype = "Gaussian", grname = "id", nboot = 1000, npermut = 100)
...
#### v2
```{r}
v2.rpt <- rpt(v2 ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = ir.out.bluti_bal, datatype = "Gaussian", grname = "id", nboot = 1000, npermut = 100)

v2.rpt
```
#### v3
```{r}
v3.rpt <- rpt(v3 ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = ir.out.bluti_bal, datatype = "Gaussian", grname = "id", nboot = 1000, npermut = 100)

v3.rpt
```
#### v4
```{r}
v4.rpt <- rpt(v4 ~ 1  + day_since*exp_group + scare_outcome + prev_scares + flight_no  + sex + age + hr+ celsius.now + date_label + (1|id), data = ir.out.bluti_bal, datatype = "Gaussian", grname = "id", nboot = 1000, npermut = 100) 
